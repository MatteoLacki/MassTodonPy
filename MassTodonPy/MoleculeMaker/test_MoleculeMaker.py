...
import unittest
from MassTodonPy.MoleculeMaker.MoleculeMaker import get_formulas,\
                                                    Molecule
from MassTodonPy.Data.get_data import get_dataset


class TestMoleculeMaker(unittest.TestCase):
    def setUp(self):
        """Set up a method."""
        pass
    ...
    def test_make_formulas(self):
        ...
        expected_formulas = set(Molecule(name, atomcnt_str, q, g)
