...
htmlhelp_basename = 'MassTodondoc'
...
latex_documents = [
    (master_doc, 'MassTodon.tex', u'MassTodon Documentation',
     u'MatteoLack', 'manual'),
]
...
man_pages = [
    (master_doc, 'masstodon', u'MassTodon Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MassTodon', u'MassTodon Documentation',
     author, 'MassTodon', 'One line description of project.',
     'Miscellaneous'),
]
